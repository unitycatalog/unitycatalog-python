...
`src/unitycatalog/lib/` and `examples/` directories are exceptions and will never be overridden.
...
```bash
pip install git+ssh://git@github.com/samster25/unitycatalog-python.git
```
